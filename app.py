...
url = 'https://dl.dropboxusercontent.com/scl/fi/75otqj759wquk4koegpul/image_classifier.h5?rlkey=oppfqe801mh6t13t4kdkscuu4&st=6rkp9cge'

# Download the model file
response = requests.get(url)
with open('image_classifier.h5', 'wb') as f:
